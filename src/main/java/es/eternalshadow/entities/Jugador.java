...
public class Jugador extends Criatura {
	...
	@Transient
	private Map<String, ItemDTO> inventario = new HashMap<>();
	...
	public Jugador(String tipo, String nombre, int fuerza, int resistencia,
			int velocidad, int magia, int puntosVida, int moral) {
	...
	public Jugador(String tipo, String nombre, int fuerza, int resistencia,
			...
			int defensa, Map<String, ItemDTO> inventario) {
		super(tipo, nombre, fuerza, resistencia, velocidad, magia, puntosVida);
		setAtaque(ataque);
		setDefensa(defensa);
		this.moral = moral;
	...
	public Jugador(String tipo, String nombre, int fuerza, int resistencia,
			int velocidad, int magia, int puntosVida, int moral, int ataque,
			int defensa) {
		this(tipo, nombre, fuerza, resistencia, velocidad, magia, puntosVida,
				moral, ataque, defensa, new HashMap<>());
	}
	...
	public void setArmasJugador(List<Arma> armasJugador) {
		this.armasJugador = armasJugador != null ? armasJugador
				: new ArrayList<>();
	}
	...
	public void setEscudosJugador(List<Escudo> escudosJugador) {
		this.escudosJugador = escudosJugador != null ? escudosJugador
				: new ArrayList<>();
	}
	...
	public String toString() {
		return "Jugador [nombre=" + getNombre() + ", nivel=" + getNivel()
				+ ", puntosVida=" + getPuntosVida() + ", moral=" + moral
				+ ", ataque=" + getAtaque() + ", defensa=" + getDefensa()
				+ ", armasJugador=" + armasJugador + ", escudosJugador="
				+ escudosJugador + "]";
	}
}